...
int main()
{
    ...
    cout << "Shaswat' public key Pa = " << a << "*" << G << " = " << Pa << endl<<"\n";
    ...
    cout << "Alice sends Bob = {Pa,(c1,c2)} = {" << Pa << ", (" << c1 << ", " << c2 << ")}\n\n";
    Pk = b*Pa;
    ec_t::ffe_t m1d = c1/Pk.x();
    ec_t::ffe_t m2d = c2/Pk.y();
    cout << "Amitesh's decrypted message from Shaswat = (" << m1d << ", " << m2d << ")" << endl;
    Pk = j*Pa;
    m1d = c1/Pk.x();
    m2d = c2/Pk.y();
    cout << "\nBut Mam's decrypted message from Shaswat is = (" << m1d << ", " << m2d << ")" << endl;
    cout << endl;
    system("PAUSE");
    return EXIT_SUCCESS;
}
